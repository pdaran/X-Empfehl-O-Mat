...
ActiveRecord::Schema[7.0].define(version: 2023_06_04_144401) do
  ...
  create_table "shop_registrations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id"], name: "index_shop_registrations_on_shop_id"
    t.index ["user_id"], name: "index_shop_registrations_on_user_id"
  end
  ...
  create_table "shops2", force: :cascade do |t|
    t.string "name"
    t.string "adresse"
  ...
  add_foreign_key "categories", "shops2", column: "shop_id"
  ...
  add_foreign_key "shop_registrations", "shops2", column: "shop_id"
  add_foreign_key "shop_registrations", "users"
end
