...
```
cd existing_repo
git remote add origin https://gitlab.plagge.it/fh-aachen/ip/x-empfehl-o-mat.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.plagge.it/fh-aachen/ip/x-empfehl-o-mat/-/settings/integrations)
